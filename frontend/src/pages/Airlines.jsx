...
function PermissionToggleCard({
  ...
  return (
    <div
      ...
      className={`group relative flex items-start gap-3.5 p-3.5 rounded-xl border transition-all duration-200 cursor-pointer select-none ${
        checked
          ? 'bg-blue-50/50 border-blue-200/90 ring-1 ring-blue-500/10 shadow-2xs'
          : 'bg-white border-slate-200/80 hover:border-slate-300 hover:bg-slate-50/60'
      } ${disabled ? 'opacity-60 cursor-not-allowed' : ''}`}
    >
      <div className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 border mt-0.5 transition-colors ${
        checked ? `${iconBg} ${iconColor}` : 'bg-slate-100 border-slate-200/80 text-slate-500 group-hover:text-slate-700'
      }`}>
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between gap-3">
          <p className={`text-xs font-bold leading-snug ${checked ? 'text-slate-900' : 'text-slate-700 group-hover:text-slate-900'}`}>
            {title}
          </p>
          ...
          <div
            ...
            className={`w-9 h-5 flex items-center rounded-full p-0.5 flex-shrink-0 transition-colors duration-200 ease-in-out ${
              checked ? 'bg-blue-600 shadow-xs' : 'bg-slate-200'
            }`}
          >
            <div
              ...
              >
                ...
                <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100 bg-slate-50/50">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-base font-bold text-slate-900 tracking-tight">Edit Airline</h2>
                      <p className="text-xs text-slate-500 mt-0.5">Manage organization profile and feature permissions</p>
                    </div>
                  </div>
                  <button
                    onClick={closeEditAirline}
                ...
                <div className="p-6 space-y-5 max-h-[68vh] overflow-y-auto">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={editAirline.airlineName}
                      onChange={e => setEditAirline(prev => ({ ...prev, airlineName: e.target.value }))}
                      className="w-full border border-slate-200 rounded-xl px-3.5 py-2.5 text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 bg-slate-50/30 focus:bg-white hover:border-slate-300 transition-all shadow-2xs"
                      placeholder="e.g. DHL Bahrain"
                      autoFocus
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      value={editAirline.address}
                      rows={2}
                      onChange={e => setEditAirline(prev => ({ ...prev, address: e.target.value }))}
                      className="w-full border border-slate-200 rounded-xl px-3.5 py-2.5 text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 bg-slate-50/30 focus:bg-white hover:border-slate-300 transition-all shadow-2xs resize-y"
                      placeholder="Enter airline street, city, country..."
                    />
                  </div>
                  ...
                  <div className="pt-1">
                    <div className="flex items-center gap-2 mb-2.5">
                      ...
                      <span className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Access & Permissions</span>
                    </div>
                    <div className="space-y-2.5">
                      <PermissionToggleCard
                        ...
                        title="Allow this airline to create and assign its own exams"
                        description="Adds a 'Manage Exams' area where the airline builds exams, emails them to its own students, and views results."
                        checked={editAirline.can_author_exams}
                        onChange={val => setEditAirline(prev => ({ ...prev, can_author_exams: val }))}
                      />
                      <PermissionToggleCard
                        icon={Users2}
                        iconColor="text-purple-600"
                        iconBg="bg-purple-50 border-purple-200/80"
                        title="Allow this airline to create its own sub-users (departments)"
                        description="Adds a 'Team' area where the airline creates department logins and grants each a subset of its own powers."
                ...
                <div className="px-6 py-4 bg-slate-50/70 border-t border-slate-100 flex items-center justify-end gap-3">
                  ...
                  <button
                    type="button"
                    onClick={saveEditAirline}
                    disabled={savingAirline}
                    className="px-5 py-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-semibold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-sm hover:shadow-md transition-all active:scale-[0.98] disabled:opacity-60"
                  >
                    {savingAirline && <Spin cls="w-3.5 h-3.5 border-2 border-white/30 border-t-white" />}
              ...
              >
                ...
                <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100 bg-slate-50/50">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-base font-bold text-slate-900 tracking-tight">Create Airline Account</h2>
                      <p className="text-xs text-slate-500 mt-0.5">Registers the account directly — no email verification required.</p>
                    </div>
                  </div>
                  <button onClick={closeCreateAirline} className="p-2 rounded-xl text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-all">
                    <HiOutlineX className="w-5 h-5" />
                  </button>
                </div>
                ...
                <div className="p-6 space-y-4 max-h-[68vh] overflow-y-auto">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                    ...
                    <div>
                      <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">Airline Name</label>
                  ...
                  <div>
                    <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">Address <span className="text-slate-400 font-normal normal-case">(optional)</span></label>
                  ...
                  <div>
                    <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">Company Logo <span className="text-slate-400 font-normal normal-case">(optional)</span></label>
                    {createLogoPreview ? (
                      <div className="flex items-center gap-3 border border-slate-200 rounded-xl p-3 bg-slate-50/50">
                        <img src={createLogoPreview} alt="Logo preview" className="w-10 h-10 rounded-lg object-contain flex-shrink-0 bg-white border border-slate-200" />
                        <div className="min-w-0 flex-1">
                          <p className="text-xs font-semibold text-slate-800 truncate">{createLogoFile?.name || 'logo image'}</p>
                          <p className="text-[11px] text-slate-400">{((createLogoFile?.size || 0) / 1024).toFixed(0)} KB</p>
                        </div>
                        <button type="button" onClick={clearCreateLogo}
                          className="p-1.5 rounded-lg hover:bg-slate-200 text-slate-400 flex-shrink-0 transition-colors"><HiOutlineX className="w-4 h-4" /></button>
                      </div>
                    ) : (
                      <button type="button" onClick={() => createLogoInputRef.current?.click()}
                        className="w-full flex items-center justify-center gap-2 border-2 border-dashed border-slate-200 hover:border-blue-400 rounded-xl px-4 py-3 text-xs font-medium text-slate-600 hover:text-blue-600 bg-slate-50/30 hover:bg-blue-50/20 transition-all">
                        <HiOutlineDocumentDownload className="w-4 h-4 rotate-180 text-slate-400" />
                        Upload airline logo image
                        <span className="text-slate-400">· PNG, JPG · max 2MB</span>
                      </button>
                    )}
                  ...
                  <div className="pt-2">
                    ...
                    <div className="space-y-2.5">
                      <PermissionToggleCard
                        ...
                        iconBg="bg-blue-50 border-blue-200/80"
                        title="Allow this airline to create and assign its own exams"
                        description="Adds a 'Manage Exams' area where the airline builds exams, emails them to students, and views results."
                        checked={createAirline.can_author_exams}
                        onChange={val => setCreateAirline(prev => ({ ...prev, can_author_exams: val }))}
                      />
                      <PermissionToggleCard
                        icon={Users2}
                        iconColor="text-purple-600"
                ...
                {/* Footer */}
                <div className="px-6 py-4 bg-slate-50/70 border-t border-slate-100 flex items-center justify-end gap-3">
                  <button onClick={closeCreateAirline} className="px-4 py-2.5 rounded-xl border border-slate-200 text-slate-700 bg-white hover:bg-slate-50 hover:border-slate-300 font-medium text-xs sm:text-sm transition-all shadow-2xs">Cancel</button>
                  <button onClick={saveCreateAirline} disabled={creatingAirline}
                    className="px-5 py-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-semibold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-sm hover:shadow-md transition-all active:scale-[0.98] disabled:opacity-60">
                    {creatingAirline && <Spin cls="w-3.5 h-3.5 border-2 border-white/30 border-t-white" />}
